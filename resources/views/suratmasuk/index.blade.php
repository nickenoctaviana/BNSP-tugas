...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h3><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Daftar Surat</h3>
                <hr />
            </div>
        </div>
        <div>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/suratmasuk/{{$suratmasuk->id}}/delete"
                                    ...
                                    onclick="return confirm('Apakah anda yakin ingin menghapus arsip surat ini ?')"><i class="nav-icon fas fa-trash"></i>
                                    Hapus</a>
                            </td>
                        </tr>
